...
export const Gallery = (): JSX.Element => {
  ...
  const translations = {
    de: {
      ...
      header: {
        title: "Galerie",
        subtitle: "Schauen Sie sich unsere Sammlung wunderschöner Nagelkunst und inspirierender Designs an"
      }
    },
    en: {
      nav: {
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-2 text-beige-600 dark:text-beige-300">
                {currentLanguage === 'de' ? 'Laden...' : 'Loading...'}
              </span>
            </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-lg text-beige-600 dark:text-beige-300">
                {currentLanguage === 'de' 
                  ? 'Galerie wird bald mit neuen Bildern aktualisiert.'
      ...
      <section className="py-20 bg-gradient-to-r from-beige-50 to-beige-100 dark:from-gray-800 dark:to-gray-700">
        <div className="max-w-4xl mx-auto text-center px-6">
          <h2 className="text-4xl font-ephesis font-bold text-miuna-600 mb-6">
            {currentLanguage === 'de' ? 'Lassen Sie sich inspirieren?' : 'Ready to Get Inspired?'}
          </h2>
          <p className="text-xl text-beige-600 dark:text-beige-300 mb-8 leading-relaxed">
            {currentLanguage === 'de' 
              ? 'Buchen Sie noch heute Ihren Termin und lassen Sie uns aus Ihren Nägeln ein Kunstwerk machen.'
