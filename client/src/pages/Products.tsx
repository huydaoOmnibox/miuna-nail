...
export const Products = (): JSX.Element => {
  ...
  const translations = {
    de: {
      ...
      header: {
        title: "Produkte",
        subtitle: "Entdecken Sie unsere Premium-Nagelpflegeprodukte"
      },
      filters: {
        all: "Alle",
      ...
      product: {
        contactForPrice: "Kontakt für Preis",
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-2 text-beige-600">
                {currentLanguage === 'de' ? 'Produkte laden...' : 'Loading products...'}
              </span>
            </div>
          ) : products.length === 0 ? (
                  ...
                  <CardContent className="pt-0">
                    <div className="flex justify-between items-center">
                      ...
                      <Button 
                        ...
                        onClick={() => window.open('https://wa.me/31628699827', '_blank')}
                      >
                        {currentLanguage === 'de' ? 'Bestellen' : 'Order'}
                      </Button>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 bg-gradient-to-r from-beige-50 to-beige-100 dark:from-gray-800 dark:to-gray-700">
        <div className="max-w-4xl mx-auto text-center px-6">
          <h2 className="text-4xl font-ephesis font-bold text-miuna-600 mb-6">
            {currentLanguage === 'de' ? 'Bereit zum Bestellen?' : 'Ready to Shop?'}
          </h2>
          <p className="text-xl text-beige-600 dark:text-beige-300 mb-8 leading-relaxed">
            {currentLanguage === 'de' 
              ? 'Entdecken Sie unsere Premium-Nagelpflegeprodukte und treffen Sie Ihre Wahl.'
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              {currentLanguage === 'de' ? 'JETZT SHOPPEN' : 'SHOP NOW'}
            </Button>
          </div>
        </div>
      </section>
